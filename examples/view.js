    ...
    App.prototype.render = function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                "h2",
                null,
                "\bQtext: React editor base on Draft-js test render view"
            ),
            React.createElement(
                "p",
                null,
                React.createElement(
                    ...
                    { onClick: function onClick() {
                            console.log(JSON.stringify(_this2.editor ? _this2.editor.getData() : {}, null, 4));
                        } },
                    "log editor data"
                )
            ),
            React.createElement(
                "div",
                null,
                React.createElement(QtextView_1.QTextView, { className: styles.showbox, ref: function ref(r) {
...
module.exports = {"showbox":"showbox___2W9MY"};
