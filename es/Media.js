...
export var Media = function (_React$Component) {
...
var Video = function Video(props) {
    ...
    var id = getYoutubeVideoId(props.src);
    var cProps = {
    ...
    var vimeoId = getVimeoId(props.src);
    if (vimeoId) {
...
export var MediaView = function (_React$PureComponent) {
