...
import { STYLE_LIST, fontFamilyStyleMap, fontSizeStyleMap, colorStyleMap } from "./const";
...
export var ToolBar = function (_React$PureComponent) {
    ...
    function ToolBar() {
        ...
        _this2.linkConfirm = function (name, url, newTarget) {
            ...
            changeEditState(RichUtils.toggleLink(newEditorState, newEditorState.getSelection(), entityKey));
        };
        _this2.mediaConfirm = function (style, name, url) {
            ...
            changeEditState(AtomicBlockUtils.insertAtomicBlock(newEditorState, entityKey, " "));
        };
    ...
    ToolBar.prototype.render = function render() {
        ...
        return React.createElement(
            ...
            React.createElement(Media, { type: TMedia.link, icon: "link", ref: function ref(r) {
            ...
            React.createElement(Media, { type: TMedia.video, icon: "video-camera", label: "\u89C6\u9891", onToggle: this.mediaConfirm }),
            React.createElement(Media, { type: TMedia.audio, icon: "music", label: "\u97F3\u9891", onToggle: this.mediaConfirm }),
            React.createElement(Media, { type: TMedia.image, icon: "picture-o", label: "\u56FE\u7247", onToggle: this.mediaConfirm })
        );
    };
    ...
    ToolBar.prototype.modeBtn = function modeBtn() {
        ...
        return React.createElement(ListStyle, { data: {
                desktop: {},
                mobile: {}
    ...
    ToolBar.prototype._renderColors = function _renderColors() {
        ...
        return React.createElement(ListStyle, { data: colorStyleMap, icon: "eyedropper", label: "\u989C\u8272\u8BBE\u7F6E", width: 100, onToggle: function onToggle(style) {
    ...
    ToolBar.prototype._renderFamily = function _renderFamily() {
        ...
        return React.createElement(ListStyle, { data: fontFamilyStyleMap, icon: "font", label: "\u5B57\u4F53\u8BBE\u7F6E", width: 160, onToggle: function onToggle(style) {
    ...
    ToolBar.prototype._renderFontSize = function _renderFontSize() {
        ...
        return React.createElement(ListStyle, { data: fontSizeStyleMap, icon: "text-height", label: "\u5B57\u4F53\u5927\u5C0F\u8BBE\u7F6E", width: 100, onToggle: function onToggle(style) {
